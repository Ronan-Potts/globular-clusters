...
id_position_df = id_position_df[id_position_df["Name"] != "remove.txt"]

# Write clean file
id_position_df.to_csv('./clusters-harris/clean/id_position_data.txt', sep=',', index=False)

'''
Checking for GCs in clean-clusters which aren't in Harris data
'''

f_data = pd.read_csv('./clean-clusters/GCs_Summary.txt', sep=',', header=0)
